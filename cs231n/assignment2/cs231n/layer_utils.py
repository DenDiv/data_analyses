...
def affine_bn_relu_dropout_forward(x, w, b, bn_args = None, dropout_param = None):
    ...
    if bn_args is not None:
        out, bn_cache = batchnorm_forward(out, *bn_args)
...
def affine_bn_relu_forward(x, w, b, bn_args = None):

    a, fc_cache = affine_forward(x, w, b)

    if bn_args is not None:

        z, bn_cache = batchnorm_forward(a, *bn_args)
